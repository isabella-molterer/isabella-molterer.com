  ...
  <div class="page page-privacy container">
    ...
    <div class="privacy">
      <div class="privacy__headline-wrapper">
        <h1 class="privacy-headline headline headline--has-separator">Privacy Policy</h1>
      </div>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to Isabella Molterer.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Isabella Molterer, accessible from <a
                href="https://isabella-molterer.com" rel="external nofollow noopener"
                target="_blank">https://isabella-molterer.com</a></p>
          </li>
          <li>
